            ...
            <View style={styles.container} >
                ...
                <Animatable.View style={[styles.footer, { backgroundColor: colors.background }]} animation="fadeInUpBig" >
                    ...
                    <View style={styles.action}>
                        <Ionics name="ios-person-outline" color={colors.text} size={20} />
                    ...
                    <View style={styles.action}>
                        <Ionics name="ios-person-sharp" color={colors.text} size={20} />
                    ...
                    <Text style={[styles.text_footer, { color: colors.text }, { marginTop: 20 }]}> Player Name for Guardian </Text>
                    <View style={styles.action}>
                        <Ionics name="ios-people-sharp" color={colors.text} size={20} />
                        <TextInput placeholder="Guardian Of Player" style={styles.textInput}
                            secureTextEntry={data.secureTextEntry ? true : false} autoCapitalize="none"
