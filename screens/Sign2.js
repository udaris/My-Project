...
import { AddUser2, AddAdmins } from '../Firebase/Users';
    ...
    SignUptoFirebase = () => {
        ...
        SignUp(this.state.email, this.state.password).
            then((res) => {
                ...
                AddUser2(this.state.name, '', this.state.email, '', userUID).
                    then(() => {
                        AddAdmins(this.state.name, '', this.state.email, '', userUID).
                        then(() => {
                    ...
                    <Animatable.View style={[styles.footer, { backgroundColor: 'white' }]} animation="fadeInUpBig" >
                        ...
                        <View style={styles.button}>
                            <TouchableOpacity style={styles.signIn} onPress={() => this.SignUptoFirebase()} >
                                <LinearGradient colors={['#2f4f4f', '#00695C']} style={styles.signIn}  >
