        ...
        <ScrollView>
            <View style={styles.container} >
                ...
                <Animatable.View style={[styles.footer, { backgroundColor: colors.background }]} animation="fadeInUpBig" >
                    ...
                    <Text style={[styles.text_footer, { color: colors.text }, { marginTop: 20 }]}> Guardian Of Player </Text>
                    <View style={styles.action}>
                        <Ionics name="ios-people-sharp" color={colors.text} size={18} />
                    ...
                    <View style={styles.action}>
                        <FontsAw name="user-o" color={colors.text} size={18} />
